...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/admin')}}" class="logo">
            ...
            <span class="logo-lg"><b>Affiliate Family</b></span>
        </a>
    ...
    <footer class="main-footer text-center">
        ...
        <strong >All Right Reservied @ Affiliate Family Co. ,, Powerd By <a href="https://www.facebook.com/abdo.kazanova.14/" target="_blank">Negm</a>.</strong>
    </footer>
