...
<head>
    ...
    <title>Affiliate Family Dashboard</title>
    ...
    @if(app()->getLocale() == 'ar')
        ...
        <link rel="stylesheet" href="{{asset('back/dist/css/AdminLTE-rtl.min.css')}}">
        <link rel="stylesheet" href="{{asset('back/dist/css/AdminLTE-rtl.css')}}">
        <link rel="stylesheet" href="{{asset('back/dist/css/bootstrap-rtl.css')}}">
...
<div class="register-box">
    <div class="register-logo">
        <a href=""><b>Affiliate Family </b>Dashboard</a>
    </div>
